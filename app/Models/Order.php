...
class Order extends Model
{
    ...
    protected $fillable = ['status', 'total_price', 'created_by', 'updated_by','shipping','insurance','ship_method','pay_method','discount_amount','bill_id','ship_id','fullprice','boxes','vc','boxcount','enpro_doc','discount_percent','tracking','products_total_weight_g','products_plus_buffer_g'];
