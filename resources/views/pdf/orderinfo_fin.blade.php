    ...
    <br>
        <table class='items'>
            ...
            <tfoot class='right'>
                ...
                <tr><td colspan="4">discount :</td><td>- {{number_format($order['discount_amount'],2)}}</td></tr>
                <tr><td colspan="4">shipping fee :</td><td>{{number_format($order['shipping'],2)}}</td></tr>
                <tr><td colspan="4">insurance :</td><td>{{number_format($order['insurance'],2)}}</td></tr>
                <tr>
