...
<div>
    <button>    
        <a href="{{route('order.view', $order, true)}}">Order #{{$order->id}}
            Link to your order:
        </a>
    </button>
</div>
...
<div>
   ...
   NOTE:  
    ...
    </br>All of our products are handmade, therefore, the colors and shapes may not be exactly the same as in the picture. Each piece will be slightly different.
    </br>For further assistance please e-mail to us at shoponline@prempracha.com or add LINE ID showroomprem or call 053-338-540.
    </p>
